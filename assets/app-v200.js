...
if (typeof API_BASE === 'undefined') {
  var API_BASE = "https://workpro-api.onrender.com";
}
function getHeaders() {
...
async function applyToJob(data) {
  try {
    ...
    const isAlreadyApplied = msg.toLowerCase().includes("already applied") || (() => {
      try {
        return JSON.parse(msg)?.error?.toLowerCase().includes("already");
      } catch (_) {}
      return false;
    })();
    if (isAlreadyApplied) {
...
function Profile({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "form-group"
  }, /*#__PURE__*/React.createElement("label", null, "Availability"), /*#__PURE__*/React.createElement("select", {
    ...
    value: "busy"
  }, "Busy"), /*#__PURE__*/React.createElement("option", {
    value: "away"
  }, "Away"), /*#__PURE__*/React.createElement("option", {
    value: "unavailable"
  ...
  }, /*#__PURE__*/React.createElement("h2", null, profile?.username || user?.username || "Pi User"), profile?.title && /*#__PURE__*/React.createElement("p", {
    className: "profile-title"
  }, profile.title), /*#__PURE__*/React.createElement("p", {
    className: "profile-username"
  }, "@", profile?.username || user?.username || "piuser"), profile?.availability && profile.availability !== "available" && /*#__PURE__*/React.createElement("p", {
    className: "profile-availability",
    style: {
      color: "#f59e0b",
      fontSize: 13
    }
  }, profile.availability.charAt(0).toUpperCase() + profile.availability.slice(1)))), profile?.bio && /*#__PURE__*/React.createElement("div", {
    ...
    className: "stat-value"
  }, profile?.total_jobs_posted ?? 0), /*#__PURE__*/React.createElement("span", {
    className: "stat-label"
  }, "Jobs Posted")), /*#__PURE__*/React.createElement("div", {
    className: "stat-item"
  }, /*#__PURE__*/React.createElement("span", {
    className: "stat-value"
  }, profile?.total_jobs_completed ?? 0), /*#__PURE__*/React.createElement("span", {
    className: "stat-label"
  }, "Jobs Completed")), /*#__PURE__*/React.createElement("div", {
    className: "stat-item"
  }, /*#__PURE__*/React.createElement("span", {
    className: "stat-value"
  }, profile?.rating ? parseFloat(profile.rating).toFixed(1) : "N/A"), /*#__PURE__*/React.createElement("span", {
    className: "stat-label"
  }, "Rating"))), (profile?.location || safeWebsite(profile?.website)) && /*#__PURE__*/React.createElement("div", {
    className: "profile-section"
  }, /*#__PURE__*/React.createElement("h3", null, "Contact Info"), profile?.location && /*#__PURE__*/React.createElement("p", null, "\uD83D\uDCCD ", profile.location), safeWebsite(profile?.website) && /*#__PURE__*/React.createElement("p", null, "\uD83C\uDF10", " ", /*#__PURE__*/React.createElement("a", {
...
function Admin({
  ...
  const fetchData = async () => {
    ...
    setError("");
    try {
      const [jobsData, usersData, statsData] = await Promise.all([apiFetch("/api/admin/jobs/all"), apiFetch("/api/admin/users"), apiFetch("/api/admin/stats")]);
  ...
  if (loading) {
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "spinner large"
    }), /*#__PURE__*/React.createElement("p", null, "Loading admin data..."));
  }
  if (error) {
    return /*#__PURE__*/React.createElement("div", {
      className: "error-container"
    }, /*#__PURE__*/React.createElement("h2", null, "Error"), /*#__PURE__*/React.createElement("p", null, error), /*#__PURE__*/React.createElement("button", {
      className: "btn btn-primary",
      onClick: fetchData
    }, "Retry"));
  }
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "page-header"
  }, /*#__PURE__*/React.createElement("h1", null, "Admin Dashboard")), stats && /*#__PURE__*/React.createElement("div", {
    className: "stats-grid"
  }, /*#__PURE__*/React.createElement("div", {
    className: "stat-card"
  }, /*#__PURE__*/React.createElement("div", {
    className: "stat-number"
  }, stats.total_jobs || jobs.length || 0), /*#__PURE__*/React.createElement("div", {
    className: "stat-label"
  }, "Total Jobs")), /*#__PURE__*/React.createElement("div", {
    className: "stat-card"
  }, /*#__PURE__*/React.createElement("div", {
    className: "stat-number"
  }, stats.total_users || users.length || 0), /*#__PURE__*/React.createElement("div", {
    className: "stat-label"
  }, "Total Users")), /*#__PURE__*/React.createElement("div", {
    className: "stat-card"
  }, /*#__PURE__*/React.createElement("div", {
    className: "stat-number"
  }, stats.total_applications || 0), /*#__PURE__*/React.createElement("div", {
    className: "stat-label"
  }, "Applications")), /*#__PURE__*/React.createElement("div", {
    className: "stat-card"
  }, /*#__PURE__*/React.createElement("div", {
    className: "stat-number"
  }, stats.total_escrows || 0), /*#__PURE__*/React.createElement("div", {
    className: "stat-label"
  }, "Escrows"))), /*#__PURE__*/React.createElement("div", {
    className: "tabs"
  }, /*#__PURE__*/React.createElement("button", {
    className: `tab-btn ${tab === "jobs" ? "active" : ""}`,
    onClick: () => setTab("jobs")
  }, "Jobs (", jobs.length, ")"), /*#__PURE__*/React.createElement("button", {
    className: `tab-btn ${tab === "users" ? "active" : ""}`,
    onClick: () => setTab("users")
  }, "Users (", users.length, ")"), /*#__PURE__*/React.createElement("button", {
    className: `tab-btn ${tab === "settings" ? "active" : ""}`,
    onClick: () => setTab("settings")
  }, "Settings")), tab === "jobs" && /*#__PURE__*/React.createElement("div", {
    className: "admin-list"
  }, jobs.length === 0 ? /*#__PURE__*/React.createElement("p", null, "No jobs found.") : jobs.map(job => /*#__PURE__*/React.createElement("div", {
    key: job.id || job._id,
    className: "admin-list-item"
  }, /*#__PURE__*/React.createElement("div", {
    className: "admin-list-info"
  }, /*#__PURE__*/React.createElement("h4", {
    className: "job-list-title"
  }, job.title), /*#__PURE__*/React.createElement("div", {
    className: "job-list-meta"
  }, /*#__PURE__*/React.createElement("span", null, job.posted_by_name || job.posted_by), /*#__PURE__*/React.createElement("span", null, formatBudget(job.budget)), /*#__PURE__*/React.createElement("span", null, job.status), /*#__PURE__*/React.createElement("span", null, timeAgo(job.created_at)))), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-danger btn-sm",
    onClick: () => handleDeleteJob(job.id || job._id)
  }, "Delete")))), tab === "users" && /*#__PURE__*/React.createElement("div", {
    className: "admin-list"
  }, users.length === 0 ? /*#__PURE__*/React.createElement("p", null, "No users found.") : users.map(u => /*#__PURE__*/React.createElement("div", {
    key: u.id || u._id || u.uid,
    className: "admin-list-item"
  }, /*#__PURE__*/React.createElement("div", {
    className: "admin-list-info"
  }, /*#__PURE__*/React.createElement("h4", null, u.username || u.name || u.id), /*#__PURE__*/React.createElement("div", {
    className: "job-list-meta"
  }, /*#__PURE__*/React.createElement("span", null, u.email || "No email"), /*#__PURE__*/React.createElement("span", null, "Jobs: ", u.total_jobs_posted || 0), /*#__PURE__*/React.createElement("span", null, "Balance: ", u.balance_connects || 0, " connects"))), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-danger btn-sm",
    onClick: () => handleDeleteUser(u.id || u.uid)
  }, "Delete")))), tab === "settings" && /*#__PURE__*/React.createElement("div", {
    className: "form-card"
  }, /*#__PURE__*/React.createElement("h3", null, "Platform Settings"), /*#__PURE__*/React.createElement("div", {
    className: "form-group"
  }, /*#__PURE__*/React.createElement("label", null, "Platform Fee (%)"), /*#__PURE__*/React.createElement("div", {
    className: "form-row",
    style: {
      gap: '12px',
      alignItems: 'center'
    ...
    disabled: feeLoading
  }, feeLoading ? "Saving..." : "Save")), feeMsg && /*#__PURE__*/React.createElement("p", {
    style: {
      marginTop: '8px',
      color: feeMsg.includes("Error") ? '#e74c3c' : '#27ae60'
    }
  }, feeMsg)), settings?.effective && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: '16px',
      padding: '12px',
      background: '#f8fafc',
  ...
  }, /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("strong", null, "Current fee:"), " ", settings.effective.platform_fee_percent, "%"), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("strong", null, "Upwork fee:"), " 20% (first $500), 10% ($500-10K), 5% ($10K+)"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: '#6b7280',
      fontSize: '14px'
    }
