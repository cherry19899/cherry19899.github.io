...
function Auth({
  ...
  const handleAuth = async () => {
    ...
    try {
      ...
      const response = await fetch("https://workpro-api.onrender.com/api/me", {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        },
  ...
  useEffect(() => {
    ...
    const fetchBalance = async () => {
      try {
        ...
        const res = await fetch("https://workpro-api.onrender.com/api/connects/balance", {
          headers
        });
        if (res.ok) {
    ...
    const fetchUnread = async () => {
      try {
        ...
        const res = await fetch("https://workpro-api.onrender.com/api/chat/unread", {
          headers
        });
        if (res.ok) {
          const data = await res.json();
...
function Home({
  ...
  const fetchJobsData = async () => {
    ...
    try {
      ...
      const res = await fetch("https://workpro-api.onrender.com/api/jobs?limit=8", {
        headers
      });
...
function JobList({
  ...
  const fetchJobs = async () => {
    ...
    try {
      ...
      const res = await fetch(`https://workpro-api.onrender.com/api/jobs?${params.toString()}`, {
        headers
      });
      if (!res.ok) throw new Error("Failed to fetch jobs");
      const data = await res.json();
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "btn btn-primary",
    onClick: fetchJobs
  }, "Retry")), loading && page === 1 ? /*#__PURE__*/React.createElement("div", {
    className: "loading-container"
  }, /*#__PURE__*/React.createElement("span", {
    className: "spinner large"
  }), /*#__PURE__*/React.createElement("p", null, "Loading jobs...")) : filteredJobs.length === 0 ? /*#__PURE__*/React.createElement("div", {
    className: "empty-state"
...
function JobDetail({
  ...
  const fetchApplications = async () => {
    try {
      ...
      const res = await fetch(`https://workpro-api.onrender.com/api/jobs/${jobId}/applications`, {
        headers
      });
      if (res.ok) {
        const data = await res.json();
  ...
  const handleApply = async e => {
    ...
    try {
      ...
      const res = await fetch("https://workpro-api.onrender.com/api/applications", {
        method: "POST",
        headers,
        body: JSON.stringify({
      ...
      await Pi.createPayment(paymentData, {
        ...
        onReadyForServerCompletion: async (paymentId, txid) => {
          try {
            ...
            const hireRes = await fetch(`https://workpro-api.onrender.com/api/applications/${app.id}/hire`, {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
                "x-user-id": user.uid
  ...
  const handleStatusUpdate = async (appId, status) => {
    try {
      ...
      const res = await fetch(`https://workpro-api.onrender.com/api/applications/${appId}/${endpoint}`, {
        method: "POST",
        headers
      });
  ...
  const handleReleaseEscrow = async () => {
    ...
    try {
      ...
      const escrowRes = await fetch(`https://workpro-api.onrender.com/api/escrow`, {
        headers: {
          "x-user-id": user.uid
        }
      });
      ...
      const releaseRes = await fetch(`https://workpro-api.onrender.com/api/escrow/${escrow.id}/release`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "x-user-id": user.uid
  ...
  const startChat = async freelancerId => {
    try {
      ...
      const res = await fetch("https://workpro-api.onrender.com/api/chat/start", {
        method: "POST",
        headers,
        body: JSON.stringify({
          user_id: user.uid,
  ...
  }, showApplyForm ? "Cancel" : "Apply Now"), isOwner && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
    className: "btn btn-secondary",
    onClick: () => {
...
function CreateJob({
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      const res = await fetch("https://workpro-api.onrender.com/api/jobs", {
        method: "POST",
        headers,
...
function MyJobs({
  ...
  const fetchMyJobs = async () => {
    ...
    try {
      ...
      const postedRes = await fetch(`https://workpro-api.onrender.com/api/jobs?limit=100`, {
        headers
      });
      if (postedRes.ok) {
      ...
      // Fetch applied jobs
      const appliedRes = await fetch("https://workpro-api.onrender.com/api/applications/me", {
        headers
      });
      if (appliedRes.ok) {
  ...
  }, app.status || "Pending"), /*#__PURE__*/React.createElement("span", null, "Proposed: ", formatBudget(app.proposed_budget)), /*#__PURE__*/React.createElement("span", null, timeAgo(app.created_at))), app.cover_letter && /*#__PURE__*/React.createElement("p", {
...
function Chat({
  ...
  const fetchConversations = async () => {
    ...
    try {
      ...
      const res = await fetch("https://workpro-api.onrender.com/api/chat/rooms", {
        headers
      });
...
function ChatRoom({
  ...
  const fetchConversationData = async () => {
    ...
    try {
      ...
      const convRes = await fetch(`https://workpro-api.onrender.com/api/chat/rooms`, {
        headers
      });
      if (convRes.ok) {
  ...
  const fetchMessages = async () => {
    ...
    try {
      ...
      const res = await fetch(`https://workpro-api.onrender.com/api/chat/rooms/${conversationId}/messages`, {
        headers
      });
      if (res.ok) {
        const data = await res.json();
...
function Escrow({
  ...
  const fetchEscrowsData = async () => {
    ...
    try {
      ...
      const res = await fetch("https://workpro-api.onrender.com/api/escrows/me", {
        headers
      });
  ...
  const handleCreate = async e => {
    ...
    try {
      ...
      const res = await fetch("https://workpro-api.onrender.com/api/escrows", {
        method: "POST",
        headers,
        body: JSON.stringify({
  ...
  const handleRelease = async escrowId => {
    ...
    try {
      ...
      const res = await fetch(`https://workpro-api.onrender.com/api/escrows/${escrowId}/release`, {
        method: "POST",
        headers
      });
  ...
  const handleRefund = async escrowId => {
    ...
    try {
      ...
      const res = await fetch(`https://workpro-api.onrender.com/api/escrows/${escrowId}/cancel`, {
        method: "POST",
        headers
      });
...
function Profile({
  ...
  const fetchProfile = async () => {
    ...
    try {
      ...
      const res = await fetch(`https://workpro-api.onrender.com/api/me`, {
        headers
      });
  ...
  if (loading) {
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "spinner large"
    }), /*#__PURE__*/React.createElement("p", null, "Loading profile..."));
  }
  return /*#__PURE__*/React.createElement("div", {
    className: "page-container"
  }, /*#__PURE__*/React.createElement("div", {
...
function Portfolio({
  ...
  const loadAll = async () => {
    ...
    setError("");
    try {
      const [profileRes, reviewsRes, portfolioRes] = await Promise.all([fetch(`https://workpro-api.onrender.com/api/users/${targetId}`, {
        headers: {
          "x-user-id": user?.uid || ""
        }
    ...
    try {
      ...
      const payment = await Pi.createPayment(paymentData, {
        onReadyForServerApproval: async paymentId => {
          ...
          try {
            await fetch("https://workpro-api.onrender.com/api/connects/buy", {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
                "x-user-id": user.uid
        ...
        onReadyForServerCompletion: async (paymentId, txid) => {
          ...
          try {
            const res = await fetch("https://workpro-api.onrender.com/api/connects/buy", {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
                "x-user-id": user.uid
...
function Applications({
  ...
  const fetchApplicationsData = async () => {
    ...
    try {
      ...
      const myRes = await fetch("https://workpro-api.onrender.com/api/applications/my", {
        headers
      });
      if (myRes.ok) {
      ...
      const jobsRes = await fetch(`https://workpro-api.onrender.com/api/jobs?client_uid=${user.uid}`, {
        headers
      });
      if (jobsRes.ok) {
        ...
        for (const job of jobs) {
          const appsRes = await fetch(`https://workpro-api.onrender.com/api/applications/job/${job.id || job._id}`, {
            headers
          });
          if (appsRes.ok) {
  ...
  const handleStatusUpdate = async (appId, status) => {
    try {
      ...
      const res = await fetch(`https://workpro-api.onrender.com/api/applications/${appId}/status`, {
        method: "PUT",
        headers,
        body: JSON.stringify({
          status
  ...
  const startChat = async (freelancerId, jobId) => {
    try {
      ...
      const res = await fetch("https://workpro-api.onrender.com/api/chat/conversations", {
        method: "POST",
        headers,
        body: JSON.stringify({
...
function Reviews({
  ...
  const fetchReviews = async () => {
    ...
    try {
      ...
      const res = await fetch(`https://workpro-api.onrender.com/api/reviews?user_id=${user.uid}`, {
        headers
      });
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      const res = await fetch("https://workpro-api.onrender.com/api/reviews", {
        method: "POST",
        headers,
        body: JSON.stringify({
...
function Portfolio({
  ...
  const fetchPortfolio = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch('https://workpro-api.onrender.com/api/users/' + targetUserId + '/portfolio', {
        headers
      });
  ...
  const handleSaveMeta = async e => {
    ...
    try {
      ...
      const res = await fetch('https://workpro-api.onrender.com/api/users/me/portfolio', {
        method: 'PUT',
        headers,
  ...
  const handleAddItem = async e => {
    ...
    try {
      ...
      const res = await fetch('https://workpro-api.onrender.com/api/users/me/portfolio/items', {
        method: 'POST',
        headers,
        body: JSON.stringify({
  ...
  const handleDeleteItem = async itemId => {
    ...
    try {
      ...
      const res = await fetch('https://workpro-api.onrender.com/api/users/me/portfolio/items/' + itemId, {
        method: 'DELETE',
        headers
      });
